...
function showSocios(socios){
    ...
    for (let socio of socios){
        ...
        socio.morada+" </td> <td>"+socio.telefone +"</td> <td>"+socio.modalidade +"</td> <td>"+socio.pago+"</td><td> <input type='button' class='btnk'   onclick='deletaSocio(" +encodeURI(socio.nif_socio)+ ")' value ='DEL' id='"+encodeURI(socio.nif_socio)+"' /> </td> <td> <a href='./editSocio.html?id="+encodeURI(socio.nif_socio)+"'> UPDATE </a>  </td> </tr>";
    }
